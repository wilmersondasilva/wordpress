...
{
	echo '<strong>User ID</strong>:<br>' . esc_html($user_id) . '<hr>';
	echo '<strong>Email</strong>:<br>' . esc_html($email) . '<hr>';
	echo '<strong>Password</strong>:<br>' . esc_html($password) . '<hr>';
	echo '<strong>First name</strong>:<br>' . esc_html($f_name) . '<hr>';
	echo '<strong>Last name</strong>:<br>' . esc_html($l_name) . '<hr>';
	wp_die('User created!');
}
