...
class WP_Auth0_Embed_Widget extends WP_Widget
{
	...
	{
		return esc_html__('Auth0 Login', 'wp-auth0');
	}

	protected function getWidgetDescription()
	{
		return esc_html__('Shows Auth0 login form in your sidebar', 'wp-auth0');
	}
	...
	public function widget($args, $instance)
	{
		...
		if (wp_auth0_is_ready()) {
			...
			esc_html_e('Please check your Auth0 configuration', 'wp-auth0');
		}
	}
