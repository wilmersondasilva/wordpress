...
class WP_Auth0_Admin
{
	...
	public function admin_enqueue()
	{
		...
		wp_register_script('wpa0_async', WPA0_PLUGIN_LIB_URL . 'async.min.js', false, WPA0_VERSION, true);
		wp_register_script('wpa0_admin', WPA0_PLUGIN_JS_URL . 'admin.js', ['jquery'], WPA0_VERSION, true);
		wp_localize_script(
			'wpa0_admin',
			'wpa0',
			[
				'media_title'             => esc_html__('Choose your icon', 'wp-auth0'),
				'media_button'            => esc_html__('Choose icon', 'wp-auth0'),
				'ajax_working'            => esc_html__('Working ...', 'wp-auth0'),
				'ajax_done'               => esc_html__('Done!', 'wp-auth0'),
				'refresh_prompt'          => esc_html__('Save or refresh this page to see changes.', 'wp-auth0'),
				...
				'form_confirm_submit_msg' => esc_html__('Are you sure?', 'wp-auth0'),
